...
public class HeapSort4 {
	...
	public static void main(String[] args) {
		...
		int[] arr6 = new int[]{ 4, 1, 3, 2, 16, 9, 10, 14, 8, 7 };
		
		System.out.println("==============================");
		System.out.println(Arrays.toString(arr6));
		System.out.println("-------------------------------");
		System.out.println(Arrays.toString(heap.heapSort(arr6)));
	}
...
class Heap4{
	...
	public int[] heapSort(int[] arr){
		...
		for(int i=listLength -1; i > 0; i--){
			...
			for(int j=listLength/2 -1; j >= 0; j--){
				arr=buildMaxHeap(arr, j, listLength);
			}
	...
	public int[] buildMaxHeap(int[] arr, int i, int listLength){
		int nextIndex = i;
